...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67226ab8096e43_60657561',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8fa13f0fb2f836f085e56aff6b62246d58dc44cd' => 
    array (
      0 => '_header.tpl',
      1 => 1729305448,
      2 => 'file',
...
function content_67226ab8096e43_60657561 (\Smarty\Template $_smarty_tpl) {
...
if (!$_smarty_tpl->getValue('user')->_logged_in) {?>
  ...
  <body class="<?php if ($_smarty_tpl->getValue('system')['theme_mode_night']) {?>night-mode<?php }?> visitor n_chat <?php if ($_smarty_tpl->getValue('page') == 'index' && !$_smarty_tpl->getValue('system')['newsfeed_public']) {?>index-body<?php }?>" <?php if ($_smarty_tpl->getValue('page') == 'profile' && $_smarty_tpl->getValue('system')['system_profile_background_enabled'] && $_smarty_tpl->getValue('profile')['user_profile_background']) {?>style="background: url(<?php echo $_smarty_tpl->getValue('profile')['user_profile_background'];?>
